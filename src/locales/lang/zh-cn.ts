export default {
  ...
  "多步结点图": "多步结点图",
  "多步利润计算": "多步利润计算",
  "多步利润计算说明": "添加一个或多个起始物品，并在图中为每个产物选择出售或继续处理。只有出售的叶子产物计算市场税。",
  "方案名称（可选）": "方案名称（可选）",
  "保存当前步骤": "保存当前步骤",
  "添加物品": "添加物品",
  "请选择物品": "请选择物品",
  ...
  "仅出售节点计税": "仅出售节点计税 {0}",
  "总投入成本": "总投入成本",
  "起始物品额外材料": "起始物品 {0} + 额外材料 {1}",
  "单批利润": "单批利润",
  "利润率": "利润率 {0}",
  "总处理耗时": "总处理耗时",
  "处理节点出售叶子": "{0} 个处理节点，{1} 个出售叶子",
  "小时收益": "小时收益",
  "按全部处理工时折算": "按全部处理工时折算",
  "天收益": "天收益",
  "小时收益乘24": "小时收益 × 24",
  "可拖动结点图": "可拖动结点图",
  "结点图说明": "每个节点都可以选择出售，或选择一种处理方式继续向下展开产物。",
  "市场买入": "市场买入",
  "继续处理": "继续处理",
  "出售叶子": "出售叶子",
  "重置布局": "重置布局",
  ...
  "转化": "转化",
  "无": "无",
  "未找到该产物的唯一配方": "未找到该产物的唯一配方",
  "仅同名绿色节点可连到红色输入引脚": "仅同名绿色节点可连到红色输入引脚",
  "该输入引脚已连接": "该输入引脚已连接",
  "该输入引脚不可连接": "该输入引脚不可连接",
  "变量与函数必须交替连接": "变量与函数必须交替连接",
  "只能从输出连到输入": "只能从输出连到输入",
  "无法连接": "无法连接",
  "引脚不存在": "引脚不存在",
  "请先在[上部]选择物品": "请先在[上部]选择物品",
  "输入引脚": "输入引脚",
  "输出引脚": "输出引脚",
  "自动供给（金币/茶）": "自动供给（金币/茶）",
  "未选择物品": "未选择物品",

  // 多步结点图（task05：处理方式文案 + 自动配平）
  "处理方式": "处理方式",
  "非炼金": "非炼金",
  "炼金": "炼金",
  "自动配平": "自动配平",
  ...
  "单批成本": "单批成本",
  "单批税后收入": "单批税后收入",
  "请先在第一行选择物品": "请先在第一行选择物品",

  // 多步结点图（task09：全屏/框选/行排序/保存路径/使用指南）
  "添加处理方式": "添加处理方式",
  "添加红色节点": "添加红色节点",
  "退出全屏": "退出全屏",
  "全屏": "全屏",
  ...
  "使用指南": "使用指南",
  "清空": "清空",
  "确定清空全部节点与连线吗？": "确定清空全部节点与连线吗？",
  "不显示平凡产物": "不显示平凡产物",
  "连完线后，点击自动配平": "连完线后，点击自动配平",
  "平凡产物是该行动的精华、箱子类物品、精通之油类物品，但利润还是正常算。": "平凡产物是该行动的精华、箱子类物品、精通之油类物品，但利润还是正常算。",
  "选择保存路径": "选择保存路径",
  "保存路径：{0}": "保存路径：{0}",
  "拖动排序": "拖动排序",
  "已选择保存路径 {0}": "已选择保存路径 {0}",
  ...
  "保存配方失败": "保存配方失败",
  "选择保存路径失败": "选择保存路径失败",
  "当前浏览器不支持选择目录，将改为下载文件": "当前浏览器不支持选择目录，将改为下载文件",

  // 多步结点图（task10：配平/配方存取/指南/蓝图逻辑）
  "保存配方": "保存配方",
  "读取配方": "读取配方",
  "读取此配方": "读取此配方",
  "删除配方": "删除配方",
  "已删除配方 {0}": "已删除配方 {0}",
  "确定删除配方 {0} 吗？": "确定删除配方 {0} 吗？",
  "已读取配方 {0}": "已读取配方 {0}",
  "读取配方失败": "读取配方失败",
  "暂无保存的配方": "暂无保存的配方",
  "请将第一行数量改为大于1的数值": "请将第一行数量改为大于1的数值",
  "该输出引脚已连接": "该输出引脚已连接",
  "主要原料与产物相同，禁止合并": "主要原料与产物相同，禁止合并",
  "会形成循环，已改为三角回流连接": "会形成循环，已改为三角回流连接",
  "三角回流线只能连接三角引脚": "三角回流线只能连接三角引脚",
  "循环回流输入": "循环回流输入",
  "循环回流出端": "循环回流出端",
  "本界面不提供任何推荐功能，只提供模拟功能": "本界面不提供任何推荐功能，只提供模拟功能",
  "查看节点": "查看节点",
  "绿色节点可以与红色节点相连，非环则合并，形成环则会有限递归计算": "绿色节点可以与红色节点相连，非环则合并，形成环则会有限递归计算",
  "炼金行动选择核心原料连线，非炼金选择核心产物连线，上方连原料，下方连产物，根据配方自动生成其他节点": "炼金行动选择核心原料连线，非炼金选择核心产物连线，上方连原料，下方连产物，根据配方自动生成其他节点"
